...
namespace bot_backEnd.SocketData
{
    public abstract class WebSocketHandler
    {
        ...
        public async Task SendMessageAsync(WebSocket socket, JObject message)
        {
            ...
            buffer: Encoding.UTF8.GetBytes(message.ToString()), //new ArraySegment<byte>(array: Encoding.UTF8.GetBytes(message.ToString()),
            //offset: 0,
            //count: message.ToString().Length + 2),
